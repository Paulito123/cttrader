...
# Info on these TypeVar can be found here: https://docs.python.org/3/library/typing.html#typing.TypeVar
T = TypeVar("T")
# Info on these ParamSpec can be found here: https://docs.python.org/3/library/typing.html#typing.ParamSpec
P = ParamSpec("P")


# Type aliasses like "Callable" and "Concatenate" are explained here:
